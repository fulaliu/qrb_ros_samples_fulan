...
setup(
    ...
    data_files=[
        ...
        ('lib/' + package_name,[package_name + "/qrb_ros_whisper_preprocess.py"]), 
        ('lib/' + package_name,[package_name + "/qrb_ros_whisper_postprocess.py"]),
    ...
    entry_points={
        'console_scripts': [
            'qrb_ros_whisper_preprocess = sample_speech_recognition.qrb_ros_whisper_preprocess:main',
	    'qrb_ros_whisper_postprocess  = sample_speech_recognition.qrb_ros_whisper_postprocess:main'
        ],
    },
)
